        ...
        <div class="row">
            <div class="large-12 columns">
                <div class="top-button">
                    <a class="button small borderShadow right rightRadius" href="<?php echo base_url();?>index.php/auth">Sign In</a>
        ...
        <div class="row">
            ...
            <div class="large-8 columns nav">
                <ul class="right inline-list">
                    ...
                    <li><a href="<?php echo base_url();?>index.php/build">Let's Build</a></li>
